...
.proc __ram_copy_line
	ldx __fe3_bank		; get current bank
...
@done:	clc
	; Preserve the final character and the truncation flag across the switch.
@ret:	php
	pha
	txa
	sta $9c02	; restore the caller's bank
	pla
	plp
	rts
.endproc
...
.proc __fe3_push_bank
	lda __fe3_bank	; get current bank
	ldx zp::banksp
	inc zp::banksp
