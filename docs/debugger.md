...
the user program.  We cannot know what memory will be affected once
...
to the original state of the frame.  For this reason, you can press select a band of the
...
|  KEY         | NAME            |   DESCRIPTION                                                                        |
|--------------|-----------------|--------------------------------------------------------------------------------------|
|   f          | FINISH FRAME    | traces the program unitl the end of the current frame and captures/displays it       |
